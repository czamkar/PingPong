...
PlayState.prototype = {
	preload: function() {
  	...
  	create: function() {
		...
		this.points1 = game.add.text(game.width/2 - 30 , 40, "0", {font: '64px Courier New', fontWeight: 'bold'});
		this.points1.anchor.setTo(0.5);
		this.points1.alpha = 0.2;
		
		this.points2 = game.add.text(game.width/2 + 30 , 40, "0", {font: '64px Courier New', fontWeight: 'bold'});
